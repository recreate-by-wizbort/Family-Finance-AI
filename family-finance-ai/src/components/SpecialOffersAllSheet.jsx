        ...
        <div className="min-h-0 flex-1 overflow-y-auto overscroll-contain px-5 pb-6 pt-4">
          <ul className="space-y-4">
            {offers.map((o) => (
              <li
                key={o.id}
                className="relative flex min-h-[140px] flex-col justify-end overflow-hidden rounded-3xl bg-[#0d1c32] p-6"
              >
                <img
